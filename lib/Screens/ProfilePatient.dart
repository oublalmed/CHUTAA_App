...
import 'package:chuta_app/Screens/Widgets/PatientWidget.dart';
...
class ProfilePatient extends StatefulWidget {
  ...
  ProfilePatient(this.patient);
  @override
  _BottomNavBarV2State createState() => _BottomNavBarV2State(this.patient);
}

class _BottomNavBarV2State extends State<ProfilePatient> {
